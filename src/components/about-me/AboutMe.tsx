...
최신 기술을 도입하기 전에 "왜 이 기술을 도입해야 하는가"에 집중하며, 컴포넌트 재사용성과 최적화, 문제 해결 능력에 큰 관심을 가지고 있습니다. 현재는 1일 1커밋과 알고리즘 스터디를 통해 내 생각을 말할 수 있는 힘을 기르고 효율적인 코드 작성할 수 있도록 노력 하고 있으며, 코드를 작성할 때는 생각 없이 키보드에 손을 올리기보다는 머리로 먼저 생각하는 습관을 들이고 있습니다.
`;
